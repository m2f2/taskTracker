          ...
          <div>
            <Menu.Button className='w-10 h-10 2xl:w-12 2xl:h-12 items-center justify-center rounded-full bg-blue-600'>
              <span className='text-white font-semibold'>
                {getInitials(user?.name)} {/* Displaying the user's initials */}
              </span>
            </Menu.Button>
          </div>
            ...
            <Menu.Items className='absolute right-0 mt-2 w-56 origin-top-right divide-gray-100 rounded-md bg-white shadow-2xl ring-1 ring-black/5 focus:outline-none'>
              ...
              <div className='p-4'>
                <Menu.Item>
                  {({ active }) => (
                    <button
                      onClick={() => setOpen(true)} // Opens the profile modal
                ...
                <Menu.Item>
                  {({ active }) => (
                    <button
                      onClick={() => setOpenPassword(true)} // Opens the change password modal
                ...
                <Menu.Item>
                  {({ active }) => (
                    <button
                      onClick={logoutHandler} // Triggers the logout function
